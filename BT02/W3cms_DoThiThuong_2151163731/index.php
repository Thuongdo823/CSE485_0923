                ...
                <div class="col-lg-12">
                    ...
                    <table class="table m-4 p-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index1.php?page_layout=edit&id=<?php echo $row['id']; ?>"><span class="icon_edit"><i class="bi bi-pencil"></i></span></a>
                                </td>
                                 <td>
                                 <a class="link-offset-2 link-underline link-underline-opacity-0 btn btn-white "
                                  onclick="return Del('<?php echo $row['fullname']; ?>')" href="index1.php?page_layout=delete&id=<?php echo $row['id']; ?>"><span class="icon_delete"><i class="bi bi-trash3"></i></span></a>
