<?php  
    $id = $_GET['id']; // Khai báo id 
    $sql_up = "SELECT * from users where id = $id"; // lệnh spl
    ...
    if(isset($_POST['sbm'])){
        ...
        $phone = $_POST['phone'];
        $birth = $_POST['dob'];
        $sql = "UPDATE users SET fullname='$fullname', email='$email', gender='$gender', groups='$groups', phone='$phone', birth = '$birth'  WHERE id='$id'";
