...
<div>
    <img src="./images/logo-full (1).png" alt="" style="width:310px">
</div>
<div class="navigation vh-100 ">
    <nav class="navbar">
        <div class="container-fluid s-bar">
            <ul class="navbar-nav  m-2">
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                        <i class="bi bi-person"></i>
                        Users
                        <span style="color: orangered;" class="badge light badge-sm  badge-primary ms-2 mb-0">Modules</span>
                    </a>
                </li>
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="bi bi-file-earmark-break"></i> Page</a>
                </li>
