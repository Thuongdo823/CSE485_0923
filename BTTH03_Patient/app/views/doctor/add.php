...
<body>
  <div class="container">
    <div class="row">
    <h3 class="text-center tex-uppercase text-success py-2 mt-3">Thông tin bác sĩ</h3>
      <div class="col-md-12 d-flex justify-content-center">
        <div class="wrapped w-25 mt-5">
          <form method="POST" action="<?=DOMAIN. '/public/index.php?controller=doctor&action=add' ?>">
            <!-- <div class="mb-3">
