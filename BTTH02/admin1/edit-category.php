<?php 
    ...
    if(isset($_GET['id'])){
        ...
        try{
            ...
            if($stmt->rowCount()>0){
                $row = $stmt->fetch(); //  gửi từng yêu cầu
            }
        }
...
<body>
    <div class="container-fluid">
        ...
        <form action="../admin1/process_edit.php" method="post">
            <div class="row mt-5">
                ...
                <div class="col-md-10">
                    ...
                    <div class="input-group flex-nowrap mt-5">
                        ...
                        <input name="matheloai" type="text" class="form-control"  value="<?=$row[0]; ?>" readonly>
                    </div>
                    <div class="input-group flex-nowrap mt-5">
                        <span class="input-group-text" id="addon-wrapping">Tên thể loại</span>
                        <input name="tentheloai" type="text" class="form-control"  value="<?=$row[1];?> ">
        </div>
                </div>
                <div class="col-md-1">
                </div>
